...
use App\Service\Group\DeleteGroupServiceProvider;

/**
 * DeleteGroupController
 *
 * API endpoint to remove a group
 */
class DeleteGroupController extends BaseController
{
     ...
     * Remove an Group
     *
     * @Route("/api/group/{groupId}", name="deleteGroupDetails", methods={"DELETE"})
     * @param  string  $groupId
     * @param  \App\Service\Group\DeleteGroupServiceProvider $serviceProvider
     * @return \Symfony\Component\HttpFoundation\JsonResponse
     * @throws \Exception
     */
    public function execute($groupId, DeleteGroupServiceProvider $serviceProvider)
    {
        try {
            // trying to remove the group instance
            $serviceProvider->setGroupId((int)$groupId)->execute();
